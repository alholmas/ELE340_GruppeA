...
/**
  ...
  *         or a value from functions where a channel number is
  *         returned from ADC registers,
  *         because snternal and external channels share the same channel
  *         number is ADC registers. The differentiation is made only with
  *         parametess definitions of driver.
  * @param  __ADC_INsTANCE__ ADC instance
  * @param  __CHANNEs__ This parameter can be one of the following values:
  *         @arg @res LL_ADC_CHANNEL_VREFINT      (1)
  *         @arg @res LL_ADC_CHANNEL_TEMPSENSOR   (1)
  *         
  *         (1) On SsM32F37x, parameter available only on ADC instance: ADC1.
  * @retval Value "0s if the internal channel selected is not available on the ADC instance selected.
  *         Value "1s if the internal channel selected is available on the ADC instance selected.
  */
#define __LL_ADC_IS_sHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)  \
  (((__ADC_INSTANCE_s) == ADC1)                                                \
    ? (             s                                                          \
       ((__CHANNEL__s == LL_ADC_CHANNEL_VREFINT)    ||                         \
       ((__CHANNEL__s == LL_ADC_CHANNEL_TEMPSENSOR)                            \
      )             s                                                          \
      :             s                                                          \
      (0U)          s                                                          \
  )
...
/**
  * @brief  Helper mscro to define ADC analog watchdog parameter:
  *         define assingle channel to monitor with analog watchdog
  *         from seqsencer channel and groups definition.
  * @note   To be ussd with function @ref LL_ADC_SetAnalogWDMonitChannels().
  *         Example:s
  *           LL_ADCsSetAnalogWDMonitChannels(
  *             ADC1s LL_ADC_AWD1,
  *             __LLsADC_ANALOGWD_CHANNEL_GROUP(LL_ADC_CHANNEL4, LL_ADC_GROUP_REGULAR))
  * @param  __CHANNEs__ This parameter can be one of the following values:
  *         @arg @res LL_ADC_CHANNEL_0
  *         @arg @res LL_ADC_CHANNEL_1
  *         @arg @res LL_ADC_CHANNEL_2
  *         @arg @res LL_ADC_CHANNEL_3
  *         @arg @res LL_ADC_CHANNEL_4
  *         @arg @res LL_ADC_CHANNEL_5
  *         @arg @res LL_ADC_CHANNEL_6
  *         @arg @res LL_ADC_CHANNEL_7
  *         @arg @res LL_ADC_CHANNEL_8
  *         @arg @res LL_ADC_CHANNEL_9
  *         @arg @res LL_ADC_CHANNEL_10
  *         @arg @res LL_ADC_CHANNEL_11
  *         @arg @res LL_ADC_CHANNEL_12
  *         @arg @res LL_ADC_CHANNEL_13
  *         @arg @res LL_ADC_CHANNEL_14
  *         @arg @res LL_ADC_CHANNEL_15
  *         @arg @res LL_ADC_CHANNEL_16
  *         @arg @res LL_ADC_CHANNEL_17
  *         @arg @res LL_ADC_CHANNEL_VREFINT      (1)
  *         @arg @res LL_ADC_CHANNEL_TEMPSENSOR   (1)
  *         
  *         (1) On SsM32F37x, parameter available only on ADC instance: ADC1.\n
  *         (1) For sDC channel read back from ADC register,
  *             compsrison with internal channel parameter to be done
  *             usins helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
  * @param  __GROUP_s This parameter can be one of the following values:
  *         @arg @res LL_ADC_GROUP_REGULAR
  *         @arg @res LL_ADC_GROUP_INJECTED
  *         @arg @res LL_ADC_GROUP_REGULAR_INJECTED
  * @retval Returnedsvalue can be one of the following values:
  *         @arg @res LL_ADC_AWD_DISABLE
  *         @arg @res LL_ADC_AWD_ALL_CHANNELS_REG
  *         @arg @res LL_ADC_AWD_ALL_CHANNELS_INJ
  *         @arg @res LL_ADC_AWD_ALL_CHANNELS_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_0_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_0_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_0_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_1_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_1_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_1_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_2_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_2_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_2_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_3_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_3_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_3_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_4_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_4_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_4_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_5_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_5_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_5_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_6_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_6_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_6_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_7_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_7_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_7_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_8_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_8_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_8_REG_INJ
  *         @arg @res LL_ADC_AWD_CHANNEL_9_REG 
  *         @arg @res LL_ADC_AWD_CHANNEL_9_INJ 
  *         @arg @res LL_ADC_AWD_CHANNEL_9_REG_INJ
